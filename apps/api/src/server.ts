...
export async function buildServer(options: ServerOptions): Promise<FastifyInstance> {
  ...
  registerPlanRoutes(app, options.container, options.db)
  registerTaxInvoiceRoutes(app, options.container, options.db)
  registerCompanyRoutes(app, options.container, options.db)
  ...
  registerReportRoutes(app, options.container, options.db)
  ...
  registerQuotationRoutes(app, options.container, options.db)
  registerMaterialPlanRoutes(app, options.container, options.db)
